...
def main():
    ...
    # code = generator.generate_n_language(10, True)
    # not_code = generator.generate_n_language(10, False)
    ...
    # print("---------------------------------------------------------------------------------------------------------")
    columns = ['length', 'average_word_length', 'percentage_of_1', 'percentage_of_0', 'percentage_of_01', 'percentage_of_10', 'frequency_of_1', 'frequency_of_0', 'special', 'code']
    ...
    csv.to_CSV()
    # print("Not Code : ", generator.generate_n_language(2000, False))
